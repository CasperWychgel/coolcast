                ...
                <div class="card mb-2">
                    <div class="card-body bg-card">
                        ...
                        <div class="editshow">
                            ...
                            <label for="danger" class="btn btn-danger">Verwijder<input type="checkbox" id="danger" name="product[]" value="{{$userproduct->id}}" class="badgebox selectbox"><span class="badge">&check;</span></label>
