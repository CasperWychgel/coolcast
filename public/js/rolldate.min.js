(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = global || self, global.Rolldate = factory());
}(this, function() {
    'use strict';
        ...
        createUI: function createUI() {
            ...
            for (var i = 0; i < len; i++) {
                ...
                if (f == 'YYYY') {
                    ...
                    for (var k = 1; k <= 12; k++) {
                        itemClass = k == date.getMonth() + 1 ? 'active' : '';
                        ul += '<li class="wheel-item ' + itemClass + '" data-index="' + domMndex + '">' + '<b style="opacity: 0; ">' + (k < 10 ? '0' + k : k) + '</b>' +  months[k - 1] + '</li>';
                        domMndex++;
                    }
                } else if (f == 'DD') {
